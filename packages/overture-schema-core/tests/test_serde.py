...
class TestSerializationModes:
    ...
    def test_python_mode_output_structure(self):
        ...
        result = parse_feature(SAMPLE_FLAT_FEATURE, mode="python")
    ...
    def test_json_mode_output_structure(self):
        ...
        result = parse_feature(SAMPLE_FLAT_FEATURE, mode="json")
    ...
    def test_mode_data_consistency(self):
        ...
        python_result = parse_feature(SAMPLE_FLAT_FEATURE, mode="python")
        json_result = parse_feature(SAMPLE_FLAT_FEATURE, mode="json")
    ...
    def test_roundtrip_consistency(self):
        ...
        python_output = parse_feature(SAMPLE_FLAT_FEATURE, mode="python")

        # Parse in JSON mode, then back to Python
        json_output = parse_feature(SAMPLE_FLAT_FEATURE, mode="json")
    ...
    def test_input_format_independence(self):
        ...
        python_from_flat = parse_feature(SAMPLE_FLAT_FEATURE, mode="python")
        json_from_flat = parse_feature(SAMPLE_FLAT_FEATURE, mode="json")
        python_from_geojson = parse_feature(SAMPLE_GEOJSON_FEATURE, mode="python")
        json_from_geojson = parse_feature(SAMPLE_GEOJSON_FEATURE, mode="json")
...
class TestGeometryFormats:
    ...
    def test_geojson_geometry_input(self):
        ...
        result = parse_feature(feature, mode="python")
    ...
    def test_different_geometry_types(self):
        ...
        for point_coords in test_cases:
            ...
            result = parse_feature(point_feature, mode="python")
            assert result is not None
            geometry = result["geometry"]
            assert hasattr(geometry, "to_geo_json")
            geo_json = geometry.to_geo_json()
