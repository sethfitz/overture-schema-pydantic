...
import json
import os
from overture.schema.divisions.division_area.models import DivisionArea


def test_division_area_json_schema_baseline():
    """Test that DivisionArea generates consistent JSON Schema (baseline comparison)."""
    schema = DivisionArea.model_json_schema()
    ...
    if not os.path.exists(baseline_file):
        ...
        assert schema["title"] == "DivisionArea"
        return
